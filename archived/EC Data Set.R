...
#CSV
educationgap <- read.csv("data/educationgap.csv")
school_allrace <- read.csv("data/school_allrace.csv")
school_blackwhite <- read.csv("data/school_blackwhite.csv")
disadvantaged <- read.csv("data/disadvantaged.csv", header=FALSE)
foster <- read.csv("data/foster.csv")
homeless <- read.csv("data/homeless.csv")
migrant <- read.csv("data/migrant.csv")
disabled <- read.csv("data/disabled.csv")
